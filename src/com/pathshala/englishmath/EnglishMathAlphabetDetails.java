...
public class EnglishMathAlphabetDetails extends JPanel implements Runnable
{
	...
	private class ButtonHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getSource() == soun)
			{
				try{
					click.stop();
				 URL urlClick = EnglishMathAlphabetDetails.class.getResource("/" + characterNumber + ".wav");
	...
	public EnglishMathAlphabetDetails(int n) {
